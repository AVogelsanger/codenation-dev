...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        public Carro build() {
            ...
            if (this.placa == null)
                throw new NullPointerException("Veículo não possui placa.");
            if (this.cor == null)
                throw new NullPointerException("Cor não informada.");
            if (this.motorista == null)
                throw new EstacionamentoException("Veículo autônomo.");
